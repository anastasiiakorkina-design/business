  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "w-full max-w-lg",
        "bg-surface border border-graphite rounded-sm shadow-elevation-4",
        "p-8",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      ...
      {showClose && (
        <DialogPrimitive.Close
          className={cn(
            ...
            "border border-transparent hover:border-graphite",
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end gap-3 mt-6 pt-6 border-t border-graphite/50",
      className
    )}
    {...props}
  />
